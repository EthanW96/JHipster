package com.ethanwiden.bugtracker.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleEmailAlreadyUsedException(com.ethanwiden.bugtracker.service.EmailAlreadyUsedException ex, ServerWebExchange request) {
    ...
    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleUsernameAlreadyUsedException(com.ethanwiden.bugtracker.service.UsernameAlreadyUsedException ex, ServerWebExchange request) {
        LoginAlreadyUsedException problem = new LoginAlreadyUsedException();
        return create(problem, request, HeaderUtil.createFailureAlert(applicationName,  true, problem.getEntityName(), problem.getErrorKey(), problem.getMessage()));
    }

    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleInvalidPasswordException(com.ethanwiden.bugtracker.service.InvalidPasswordException ex, ServerWebExchange request) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.ethanwiden.bugtracker");
    }
}